        ...
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              ...
              <button className="text-red">Clear Shopping Cart</button>
            </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <Link
              ...
              className="w-96 mx-auto flex justify-center font-medium text-dark bg-dark py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-opacity-95"
            >
              Continue Shopping
            </Link>
          </div>
