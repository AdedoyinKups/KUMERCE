            ...
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  <p className="flex items-center text-dark gap-4">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
                  ...
                  <p className="flex text-dark gap-4">
                    <svg
              ...
              <form>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    <label htmlFor="firstName" className="block text-dark mb-2.5">
                  ...
                  <div className="w-full">
                    <label htmlFor="lastName" className="block text-dark mb-2.5">
