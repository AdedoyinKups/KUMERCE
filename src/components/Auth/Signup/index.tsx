              ...
              <form>
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-3 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-red/20"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-dark bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-red mt-7.5"
                >
                  Create Account
                </button>
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signin"
                    className="text-dark ease-out duration-200 hover:text-red pl-2"
                  >
                    Sign in Now
                  </Link>
                </p>
