                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${
                        productStyle === "grid"
                          ? "bg-red border-red text-dark"
                          : "text-dark bg-gray-1 border-gray-3"
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-red hover:border-red hover:text-dark`}
                    >
                      <svg
