      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
          <div className="w-full">
            ...
            <input
              ...
              id="firstName"
              placeholder="Jhon"
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-white-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-red/20"
            />
          </div>
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-gray-1 rounded-md border border-gray-3 text-white-4 py-3 pl-5 pr-9 duration-200 appearance-none outline-none focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-red/20">
              <option value="0">Australia</option>
              <option value="1">America</option>
              <option value="2">England</option>
            </select>

            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-white-4">
              <svg
        ...
        <div>
          <label
            ...
            className="text-white flex cursor-pointer select-none items-center"
          >
            <div className="relative">
              <input
                type="checkbox"
