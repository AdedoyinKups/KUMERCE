  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-0 right-0 sm:top-6 sm:right-6 flex items-center justify-center w-10 h-10 rounded-full ease-in duration-150 text-dark hover:text-meta-5 z-10"
      >
        <svg
