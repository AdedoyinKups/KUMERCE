...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-red-light-5 transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow"
      }`}
    >
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <h1 className="w-[219]
                h-[36] text-red-dark text-4xl tracking-wider font-extrabold ">KUMERCE</h1>
            </Link>
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-red"
                    >
                      <svg
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-red w-4.5 h-4.5 rounded-full text-dark">
                      {product.length}
                    </span>
                  </span>
                ...
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-red before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
