      ...
      {!smallView && (
        <div className="items-center justify-between border-t border-gray-3 py-5 px-7.5 hidden md:flex">
          ...
          <div className="min-w-[175px]">
            <p className="text-custom-sm text-white">{orderItem.createdAt}</p>
          </div>
          ...
          <div className="min-w-[213px]">
            <p className="text-custom-sm text-white">{orderItem.title}</p>
          </div>

          <div className="min-w-[113px]">
            <p className="text-custom-sm text-white">{orderItem.total}</p>
          </div>
