                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>Filters:</p>
                      <button className="text-dark">Clean All</button>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${
                        productStyle === "grid"
                          ? "bg-blue border-blue text-dark"
                          : "text-dark bg-gray-1 border-gray-3"
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-blue hover:border-blue hover:text-dark`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
                ...
                <div className="bg-white shadow-1 rounded-md p-2">
                  <ul className="flex items-center">
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-blue text-dark hover:text-dark hover:bg-blue"
                      >
                        1
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-dark hover:bg-blue"
                      >
                        2
                      </a>
                    </li>
                    ...
                    <li>
                      <button
                        ...
                        aria-label="button for pagination left"
                        type="button"
                        className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:text-dark hover:bg-blue disabled:text-gray-4"
                      >
                        <svg
                          className="fill-current"
                          width="18"
