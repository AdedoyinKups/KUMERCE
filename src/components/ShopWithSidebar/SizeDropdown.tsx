  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-red text-dark hover:bg-red hover:text-dark"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-red hover:text-dark"
        >
          <div className="relative">
